...
class MeldingsleserTest {
    ...
    val medJournalId = sendtNySøknad.medJournalId("alpha niner bogus")
    ...
    fun `meldingsleseren skal kunne lese meldinger av den typen vi ber den om og ignorere meldinger av feil type`() {
        ...
        (1..10).forEach {
            leser.lesMelding<NySøknadMedJournalId> { msg ->
                assertEquals(medJournalId, msg)
            }
        }
        forventninger.sjekkForventninger(2, 1)
    }
